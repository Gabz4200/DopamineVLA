...
**Rule number 8:** Always run "ruff check --fix", "pyrefly check" and "uv run pytest" to detect issus and prevent regressions before committing code. If you are not sure about the issues, ask for help.
