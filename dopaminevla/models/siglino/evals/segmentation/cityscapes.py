...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        val_loss, val_miou = evaluate_cityscapes(
            seg_model,
            val_loader,
            criterion,
            num_classes=args.num_classes,
        ...
        print(
            f"Epoch {epoch + 1}/{args.epochs} | Train Loss: {train_loss:.4f} | Val Loss: {val_loss:.4f} | mIoU(val): {val_miou:.4f} | Best: {best_miou:.4f} @ epoch {best_epoch}"
        )
